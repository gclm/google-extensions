...
void 0 === window.$ && (window.$ = Zepto),
    ...
    define("app/p", [],
        function(t, e) {
            ...
            var m = function(t, e) {
                ...
                w = function(t, e) {
                    return localStorage["stop-proxy"] && "true" == localStorage["stop-proxy"] ? (s.off("", "孤城落寞助手已经暂停，点击启动运行"), void chrome.proxy.settings.set({
                            value: {
                                mode: "system"
                            },
                            scope: "regular"
    ...
    define("app/notifications", [],
        function(t, e) {
            ...
            function r(t) {
                "" === t.icon && (t.icon = chrome.runtime.getURL("/images/icon.png"));
                var e = [{
                        title: "马上去看看",
